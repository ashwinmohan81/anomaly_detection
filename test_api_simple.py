...
def test_full_workflow():
    ...
    try:
        ...
        print(f"   Prediction: {single_result['predictions']['predictions']}")
        print(f"   Score: {single_result['predictions']['scores']}")
        ...
        print(f"   Anomaly rate: {batch_result['predictions']['anomaly_rate']}")
